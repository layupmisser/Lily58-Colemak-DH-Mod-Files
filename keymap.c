...
[_LOWER] = LAYOUT(
  ...
  OSM(MOD_LCTL), KC_PSLS, KC_MINS, KC_PLUS, KC_EQL,  KC_PAST,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_PIPE, KC_TILD, _______,
  OSM(MOD_LSFT), _______, KC_LPRN, KC_RPRN, KC_UNDS, _______, KC_LT,     KC_GT, _______, KC_LCBR,KC_RCBR , KC_BSLS,_______, OSM(MOD_RSFT),
                             _______, _______, _______, _______,     _______, _______, _______, _______
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
